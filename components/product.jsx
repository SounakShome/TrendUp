            ...
            <div className="container px-5 py-24 mx-auto">
                <div className="lg:w-4/5 mx-auto flex flex-wrap">
                    <div className="lg:w-1/2 lg:h-auto h-64 object-cover object-top rounded">
                        <Image width={0} height={0} style={{ width: '100%', height: '100%' }} sizes='100vw' alt="ecommerce" className="px-20 max-h-[70vh] h-[30vh] block md:mx-0 m-auto" src="https://m.media-amazon.com/images/I/713n+TxyfCL._SY879_.jpg" />
                    </div>
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                                                ...
                                                <div className="flex mx-3 gap-2">
                                                    {Object.keys(variant[colour]).map((size) => {
                                                        ...
                                                        <div key={size} className="form-radio">
                                                            <input type="radio" name="type" value={size} onClick={() => { refreshVariant(colour, size)}} className="p-2" />
                        ...
                        <div className="flex">
                            ...
                            <button onClick={() => { addToCart(variant[colour][size]["slug"], 1, variant[colour][size]["price"], variant[colour][size]["title"], size, colour) }} className="flex ml-auto text-white bg-pink-500 border-0 py-2 lg:px-4 px-2 focus:outline-none hover:bg-pink-600 rounded"><TbShoppingCartPlus className='mt-1 mr-2' />Add to Cart</button>
                            <button className="flex ml-2 text-white bg-pink-500 border-0 py-2 lg:px-4 px-2 focus:outline-none hover:bg-pink-600 rounded">Buy Now</button>
                        ...
                        <div className='mt-6 flex space-x-3 text-sm'>
                            ...
                            <button type="submit" onClick={checkPincode} className='ml-auto text-white bg-pink-500 border-0 py-2 px-6 hover:bg-pink-600 rounded'>Check</button>
                        </div>
