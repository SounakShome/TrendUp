...
export default function Home() {
  return (
    <main>
      <div>
        <Image src="/home.png" alt="home" width={1920} height={1080} />
      </div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            ...
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deserunt animi labore enim similique perferendis quisquam fuga atque sapiente inventore debitis!</p>
          </div>
