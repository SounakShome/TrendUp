...
const Stickers = () => {
  return (
      <section className="text-gray-600 body-font mx-8">
        <h1 className='m-5 px-2 text-3xl font-semibold'>Stickers</h1>
        <div className="container px-5 py-5 mx-auto">
          <div className="flex flex-wrap -m-4">
            <div className="lg:w-1/4 md:w-1/2 p-4 w-full">
              <Link href={`/products/wear-the-code`}>
                <div className="block relative rounded overflow-hidden">
                  <Image width={0} height={0} style={{ width: '50%', height: '50%' }} sizes='10vw' alt="ecommerce" className="m:h-[36vh] h-[30vh] block md:mx-0 m-auto" src="https://m.media-amazon.com/images/I/A1WJODU5YeL._SX569_.jpg" />
                </div>
                <div className="mt-4">
